...
import { selectSearchResults, selectSearchIsLoading } from '../../redux/search/selectors';
...
function Search({ searchResults, searchItem, navigation, clearSearch, isLoading}) {
	...
	return(
		<Screen noPadding>
			...
			<View style={styles.textContainer}>
				<Text style={styles.emptyText}>Search a movie or tv show by name</Text>
			</View>
			}
		</Screen>
	)
...
const mapDispatchToProps = dispatchEvent => ({
	...
	clearSearch: () => dispatchEvent(clearSearch())
})
