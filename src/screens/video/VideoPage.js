...
const VideoPage = () => {
  ...
  /* We check the platform and reder the video depending on the platform
   * Since the video does not handle the fullscreen on android, a custom implementation is needed for android phones
   */
